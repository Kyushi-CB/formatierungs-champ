...
//TODO: Set Styles in css by add classes
// set element style for each element based on status
async function setDriveState() {
    await displayDrives();
    let getDrives = document.getElementsByClassName('button-sata');
    ...
    let getSVG = document.querySelectorAll('svg');
