...
for ($i = 0; $i < count($drivePath); $i++) {
    ...
    if ($driveType[$i] == "HDD" || $driveType[$i] == "N/A") {
        echo '<button class="button-sata" id="sata-' . $i . '" type="button">';
        echo $svgHDD;    
        echo '<span class="drive-type">' . $driveType[$i] . '</span><span class="drive-name">' . $driveName[$i] . '</span><span class="drive-is-formatted">' . $driveIsFormatted[$i] . '</span></button>';
    }
    if ($driveType[$i] == "SSD") {
        echo '<button class="button-sata" id="sata-' . $i . '" type="button">';
        echo $svgSSD;    
